...
// +kubebuilder:rbac:groups=rainbond.io.rainbond.io,resources=rainbondclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rainbond.io.rainbond.io,resources=rainbondclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=rainbond.io.rainbond.io,resources=rainbondclusters/finalizers,verbs=update
...
func (r *RainbondClusterReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	if err := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		return r.Status().Update(ctx, rainbondcluster)
	}); err != nil {
