...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &rainbondv1alpha1.PrivateRegistry{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcilePrivateRegistry) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &rainbondv1alpha1.PrivateRegistry{}
...
func (r *ReconcilePrivateRegistry) daemonSetForPrivateRegistry(p *rainbondv1alpha1.PrivateRegistry) *appsv1.DaemonSet {
