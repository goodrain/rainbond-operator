...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EtcdInfo) DeepCopyInto(out *EtcdInfo) {
	*out = *in
	if in.Endpoints != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EtcdInfo.
func (in *EtcdInfo) DeepCopy() *EtcdInfo {
	if in == nil {
		return nil
	}
	out := new(EtcdInfo)
...
func (in *GlobalConfigSpec) DeepCopyInto(out *GlobalConfigSpec) {
	*out = *in
	...
	in.EtcdInfo.DeepCopyInto(&out.EtcdInfo)
	return
}
